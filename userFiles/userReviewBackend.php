...
$payload = "SELECT * FROM reviews";
$result = mysqli_query($link, $payload);

if (mysqli_num_rows($result) > 0) {
    $reviews_table .= "<table><caption>List of Reviews</caption><tr><td><b>Review ID</b></td><td><b>Appointment ID</b></td><td><b>Content</b></td><td><b>Number of Stars</b></td><td><b>Date</b></td><td><b>Time</b></td></td>";
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        $reviews_table .= "<tr><td>".$row["review_id"]."</td><td>".$row["app_id"]."</td><td>".$row["content"]."</td><td>".$row["num_stars"]."</td><td>".$row["review_date"]."</td><td>".$row["review_time"]."</td></tr>";
